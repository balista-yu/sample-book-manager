...
fun BookMapper.deleteByPrimaryKey(bookId: Int) = delete { where { id isEqualTo bookId } }
...
fun BookMapper.selectByPrimaryKey(bookId: Int) = selectOne { where { id isEqualTo bookId } }
